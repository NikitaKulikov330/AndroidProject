...
public class Mascara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_mascara);
        toolbar.setTitle("Mascara");
        setSupportActionBar(toolbar);

        FloatingActionButton fab = findViewById(R.id.fab_mascara);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Mascara.this, Cart.class);
                startActivity(intent);
            }
        });

        recyclerView = findViewById(R.id.recycler_view_mascara);
    ...
    public void onStart(){
        ...
        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(productRef.orderByChild("category").equalTo("mascara"),Products.class).build();
        FirebaseRecyclerAdapter<Products, CartAdd.ProductView> adapter = new FirebaseRecyclerAdapter<Products, CartAdd.ProductView>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartAdd.ProductView holder, int position, @NonNull Products model) {
                ...
                holder.productCart.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(Mascara.this, "Added to cart", Toast.LENGTH_SHORT).show();
