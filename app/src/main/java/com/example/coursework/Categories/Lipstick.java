...
public class Lipstick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_lipstick);
        toolbar.setTitle("Lipstick");
        setSupportActionBar(toolbar);

        FloatingActionButton fab = findViewById(R.id.fab_lipstick);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Lipstick.this, Cart.class);
                startActivity(intent);
            }
        });

        recyclerView = findViewById(R.id.recycler_view_lipstick);
    ...
    public void onStart(){
        ...
        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(productRef.orderByChild("category").equalTo("lipstick"),Products.class).build();
        FirebaseRecyclerAdapter<Products, CartAdd.ProductView> adapter = new FirebaseRecyclerAdapter<Products, CartAdd.ProductView>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartAdd.ProductView holder, int position, @NonNull Products model) {
                ...
                holder.productCart.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(Lipstick.this, "Added to cart", Toast.LENGTH_SHORT).show();
